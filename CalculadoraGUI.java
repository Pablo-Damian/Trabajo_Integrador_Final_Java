// CÓDIGO MODIFICADO PARA ADAPTARLO AL MENÚ DE APLICACIONES Y DARLE UN ASPECTO "RETRO"
...
public class CalculadoraGUI {
	...
	public CalculadoraGUI() {
		//crear ventana
		ventana = new JFrame();
		ventana.setLocation(new Point(1050, 200));
		ventana.setSize(new Dimension(290, 485));
		ventana.setTitle("Calculadora Retro");
		ventana.getContentPane().setBackground(new Color(245, 245, 220));  // COLOR "BEIGE CLARO"
		...
		display.setFont(new Font("IMPACT", PLAIN, 30));
		display.setOpaque(true);
		display.setHorizontalAlignment(SwingConstants.RIGHT);
        display.setBackground(new Color(152, 251, 152).brighter());  // COLOR "VERDE LCD"
		ventana.add(display);
